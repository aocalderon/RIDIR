...
\begin{document}
    \begin{tikzpicture}
        ...
        \draw[poly] (start) -- ++(0.25,-0.6) -- ++(-0.25,-0.5) -- ++(-0.25,-0.5)  -- ++(0.25,-0.5)
        ...
        \draw[green, fill] (8,24) circle (0.15);
        \draw[green, opacity=0.15, fill] (6,22) rectangle (8,24);
        \draw[white, fill] (7,23) rectangle (8,24);
        \draw[black] (7,23) rectangle (8,24);
        \end{tikzpicture}
\end{document} 
