...
\begin{frame}{DCEL construction}
    \centering 
    \includegraphics[width=\linewidth]{figures/Example1/SimpleDCEL} 
\end{frame}
...
\begin{frame}{What is next...}
    \begin{itemize}
        ...
        \item Still dealing with some issues during the face label assignment.
        \item Start working on Overlay operations.
        \item Testing.
    \end{itemize}
\end{frame}
