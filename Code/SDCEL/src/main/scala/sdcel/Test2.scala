...
object Test2 {
  def main(args: Array[String]): Unit = {
    ...
    val b1 = geofactory.createLineString(Array(new Coordinate(0,0), new Coordinate(1,0)))
    val b2 = geofactory.createLineString(Array(new Coordinate(1,0), new Coordinate(1,1)))
    val b3 = geofactory.createLineString(Array(new Coordinate(1,1), new Coordinate(0,1)))
    val b4 = geofactory.createLineString(Array(new Coordinate(0,1), new Coordinate(0,0)))
