...
THE_MASTER="yarn"
THE_INPUT="hdfs:///user/acald013/tmp/provinces.csv"
THE_OUTPUT="hdfs:///user/acald013/WKT/provinces"
THE_OFFSET=0
THE_PARTITIONS=1080

while getopts "i:o:p:f:l" OPTION; do
    case $OPTION in
    i)
        THE_INPUT=$OPTARG
        ;;
...
spark-submit \
    ...
    --class $CLASS_NAME $CLASS_JAR --input $THE_INPUT --offset $THE_OFFSET --output $THE_OUTPUT --partitions $THE_PARTITIONS
