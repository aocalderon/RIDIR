...
\begin{figure*}
    ...
    \subfloat[SDCEL vs CGAL. \label{fig:ca_a}]{ 
        \includegraphics[width=0.35\linewidth]{figures/experiments/CA}
    } 
    \subfloat[Focus on the most relevant number of partitions. \label{fig:ca_b}]{%
        \includegraphics[width=0.35\linewidth]{figures/experiments/CA_sample}
    }
...
\begin{figure*}
    \centering
    \includegraphics[width=0.35\linewidth]{figures/experiments/MainUS.pdf}
    \includegraphics[width=0.35\linewidth]{figures/experiments/GADM.pdf}
    \caption{Performance with MainUS and GADM datasets.} \label{fig:mainus}
    \Description[Experiments with the MainUS dataset]{This figure shows the experiments using the MainUS dataset.}
\end{figure*}

%\begin{figure}[!ht]
%    \centering
%    \includegraphics[width=0.75\linewidth]{figures/experiments/GADM.pdf}
...
\begin{figure*}
    ...
    \subfloat[MainUS Speed Up \label{fig:mainus_speedup}]{%
        \includegraphics[width=0.35\linewidth]{figures/experiments/MainUS_speedup}
    } 
    \subfloat[MainUS Scale Up \label{fig:mainus_scaleup}]{%
        \includegraphics[width=0.35\linewidth]{figures/experiments/MainUS_scaleup}
    }
...
\begin{figure*}[!ht]
    ...
    \subfloat[GADM Speed Up \label{fig:gadm_speedup}]{%
        \includegraphics[width=0.35\linewidth]{figures/experiments/GADM_speedup}
    } 
    \subfloat[GADM Scale Up \label{fig:gadm_scaleup}]{%
        \includegraphics[width=0.35\linewidth]{figures/experiments/GADM_scaleup}
    }
...
%\begin{figure}
%    \centering
%    \includegraphics[width=0.75\linewidth]{figures/experiments/Unbalance_Tester02.pdf}
%    \caption{Evaluation of the Unbalanced layers optimization using real dataset.}\label{fig:unbalance_tester2}
%    \Description[Unbalance cell methods evaluation]{This figure shows the Unbalance cell methods evaluation.}
%\end{figure}